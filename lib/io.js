...
var Sockets = function(server, wind, ee){
    ...
    if(process.env.NODE_ENV == 'production'){
        ...
        var con = redis.createClient(process.env.REDIS_PORT, process.env.REDIS_HOST, { auth_pass: process.env.REDIS_PASS });
        io.adapter(adapter({ pubClient: con, subClient: con }));
    } else {
